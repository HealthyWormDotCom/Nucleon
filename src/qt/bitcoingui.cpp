 ...
 * The Nucleon Developers 2016-2017
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Nucleon Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Nucleon_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Nucleon address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Nucleon_tooltip"), tr("&About Nucleon"), this);
    aboutAction->setToolTip(tr("Show information about Nucleon"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Nucleon"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Nucleon_tooltip"), tr("Show/Hide &Nucleon"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Nucleon window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Nucleon_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Nucleon_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Nucleon_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Nucleon client"));
    trayIcon->setIcon(QIcon(":/icons/Nucleon_tooltip"));
