...
static const int STAKE_TARGET_SPACING = 864;
static const int STAKE_MIN_AGE = 1382400;
static const int STAKE_MAX_AGE = 31536000;
...
public:
    ...
    {
        // Nucleon: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // Nucleon: get transaction coin age
...
public:
    ...
    // Nucleon: block signature - signed by coin base txout[0]'s owner
    ...
    // Nucleon: two types of block: proof-of-work or proof-of-stake
    ...
    // Nucleon: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // Nucleon: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // Nucleon: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // Nucleon: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // Nucleon: block index flags
    enum  
    {
